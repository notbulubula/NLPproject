...
class TestCalculateScores(unittest.TestCase):
    ...
    def test_get_named_entities(self) -> None:
        prompt_NE, response_NE = get_named_entities(TestCalculateScores.prompt, TestCalculateScores.response, TestCalculateScores.pipe)
    ...
    #     results = evaluate_text(TestCalculateScores.prompt, TestCalculateScores.response, TestCalculateScores.pipe)
    #     assert results[0]["NER_score"] == 1.0
    #     self.assert results[0]["prompt_mean"] == 30.0
    #     self.assert results[0]["prompt_std"] == 1.0
    #     self.assert results[0]["response_mean"] == 30.0
    #     self.assert results[0]["response_std"] == 1.0
    #     self.assert results[0]["prompt_num_dialogues"] == 0
    #     self.assert results[0]["response_num_dialogues"] == 0
