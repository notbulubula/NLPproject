...
class TestGeneratePrompt(unittest.TestCase):
    ...
    def test_generate_prompt(self) -> None:
        ...
        self.assertEqual(prompt, [
            ...
            {"role": "assistant", "content": "The story starts as follows: Hye was waiting for her usual bus at the usual bus stop near her work place . It was late at night , almost 10pm . She was all alone ."},
